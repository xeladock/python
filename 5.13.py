...
# 8: 1
# 9: 2
# https://stepik.org/lesson/22240/step/1?adaptive=true&unit=5315

# a=sorted([int(len(x)) for x in input().split(' ')])
# # print(a)
# # for aa in set(a):
# #     print(str(aa)+":",(a.count(aa)))

a=(([int(len(x)) for x in input().split(' ')]))
b=sorted(list(set(a)))
for bb in b:
    print(str(bb)+":",(a.count(bb)))